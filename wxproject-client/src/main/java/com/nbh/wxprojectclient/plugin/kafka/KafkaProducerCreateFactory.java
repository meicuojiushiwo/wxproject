...
//        defaultKafkaProducerFactory.setTransactionIdPrefix("client");
        // 为每个线程创建一个单独的生产者
...
//        defaultKafkaProducerFactory.setProducerPerThread(true);
    ...
    private Map<String, Object> producerConfigs() {
        ...
        props.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, "192.168.0.102:9092,192.168.0.106:9092,192.168.0.107:9092");
